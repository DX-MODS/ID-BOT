...
🏠 | [Home](https://t.me/suport_ziyans)
            """
    await IdBotByZiyan.send_message(message.chat.id, text, disable_web_page_preview=True)


@IdBotByZiyan.on_message(filters.command('id'))
